...
router.post('/heroi/:heroiId/completar-missao/:missaoId', token.verificaToken, userController.completarMissao);
router.get('/heroi/:id/missoes', token.verificaToken, userController.missoesHeroi);
